...
public class PickValueView extends LinearLayout implements NumberPicker.OnValueChangeListener {
     ...
     * 组件 标题、单位、滚轮
     */
    private TextView mTitleLeft, mTitleMiddle, mTitleRight,mLeftInfo;
    ...
    private void generateView() {
        ...
        titleParams.setMargins(0, 0, 0, dip2px(18));
        ...
        mLeftInfo = new TextView(mContext);//左边标题
        mLeftInfo.setTextColor(R.color.colorTheme);
        mLeftInfo.setTextSize(18);

        mTitleLeft.setTextSize(R.dimen.activity_title);
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            titles[i].setTextColor(Color.parseColor("#656565"));
        }
        ...
        contentLayout.addView(mLeftInfo);
